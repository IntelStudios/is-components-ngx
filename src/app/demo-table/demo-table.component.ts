...
<h3>Installation</h3>
<pre>npm install --save https://github.com/IntelStudios/is-components-ngx/raw/7.x/package/is-table-7.0.10.tgz
  ...
  loadData() {
    setTimeout(() => {
      ...
      for (var i = 20 - 1; i >= 0; i--) {
        rows.push(IsTableRow.deserialize({ ID: i, CanDisable: false,  IsActive: i % 7 !== 0, Data: { Company: `[danger_Company ${i}]`, Name: `${13 * i} Name` }}));
      }
